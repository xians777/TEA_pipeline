        ...
        with open(sf_out_fa, "w") as fout_fa:
            for chrm in self.m_rmsk_annotation:
                ...
                for start_pos in self.m_rmsk_annotation[chrm]:
                    ...
                    s_TE_fa_lhead = ">{0}{1}{2}{3}{4}{5}{6}L".format(chrm, S_DELIM, start_pos, S_DELIM, end_pos,
                                                                     S_DELIM,
                                                                     sub_family)  ###here still keep the original pos
                    ...
                    s_TE_fa_rhead = ">{0}{1}{2}{3}{4}{5}{6}R".format(chrm, S_DELIM, start_pos, S_DELIM, end_pos,
                                                                     S_DELIM,
                                                                     sub_family)  ###here still keep the original pos
    ...
    def load_rmsk_annotation(self):
        with open(self.sf_annotation) as fin_rmsk:
            for line in fin_rmsk:
                ...
                if start_pos not in self.m_rmsk_annotation[chrm]:
                    self.m_rmsk_annotation[chrm][start_pos] = []
                self.m_rmsk_annotation[chrm][start_pos].append((end_pos, b_rc, sub_type, csn_start, csn_end))
    ...
    def load_rmsk_annotation_with_divgnt(self):
        with open(self.sf_annotation) as fin_rmsk:
            for line in fin_rmsk:
                ...
                if start_pos not in self.m_rmsk_annotation[chrm]:
                    self.m_rmsk_annotation[chrm][start_pos] = []
                self.m_rmsk_annotation[chrm][start_pos].append(
